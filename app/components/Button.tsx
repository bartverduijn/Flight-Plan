	...
	(
		...
		return (
			<AnchorOrLink
				...
				className={clsx(
					'group inline-flex cursor-pointer outline-none overflow-hidden items-center justify-center align-middle whitespace-nowrap rounded-md select-none touch-manipulation text-center',
					{
						'h-6 text-xs px-2': size === 'small',
						'h-8 text-sm px-4': size === 'medium',
						'h-10 text-base px-6': size === 'large',
					...
					{ 'block w-full': block },
					'focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 aria-disabled:opacity-70 aria-disabled:pointer-events-none',
					className
				)}
				{...props}
			>
